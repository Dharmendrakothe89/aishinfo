<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.master" AutoEventWireup="true"
    CodeFile="quotationdetail.aspx.cs" Inherits="quotationdetail" %>
    ...
    <div id="page-wrapper" style="margin-top: 20px;">
        ...
        <div class="row">
            <div class="col-sm-12">
                        ...
                        <table cellpadding="5" cellspacing="5" border="0" width="100%">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    ...
                                    <asp:TextBox ID="txtdate" runat="server" CssClass="form-control validate[required,funcCall[DateFormat[]]"
                                        ...
                                        onblur="ValidateDate(this.id,this.value);"></asp:TextBox>&nbsp;
                                </td>
                                <td style="width: 25%;">
                                    <p>
                                ...
                                <td style="width: 25%;">
                                    ...
                                    <asp:TextBox ID="txtrefno" runat="server" CssClass="form-control validate[required]"></asp:TextBox>&nbsp;
                                </td>
                                <td style="width: 25%;">
                                    <p>
                            ...
                            <tr id="trnewparty" runat="server" style="display: none;">
                                <td>
                                    ...
                                    <asp:TextBox ID="txtnewpartyname" runat="server" CssClass="form-control validate[required]"></asp:TextBox>
                                </td>
                                <td>
                                    <p>
                                        <strong>Party Code </strong>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtnewpartyaddress" runat="server" TextMode="MultiLine" CssClass="form-control validate[required]"></asp:TextBox>
                                </td>
                                <td>
                                    <p>
                                        <strong>Contact No</strong>
                                    </p>
                                    <asp:TextBox ID="txtnewpartyno" runat="server" TextMode="MultiLine" CssClass="form-control validate[required,custom[integer]"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="trcontactperson" runat="server" style="display: none;">
                                <td>
                                    ...
                                    <asp:TextBox ID="txtpersonname" runat="server" CssClass="form-control validate[required,custom[integer]"></asp:TextBox>
                                </td>
                                <td>
                                    <p>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtemailid" runat="server" CssClass="form-control validate[required,custom[email]]"></asp:TextBox>
                                </td>
                                <td>
                                    <p>
                                        <strong>Contact No</strong>
                                    </p>
                                    <asp:TextBox ID="txtpersonno" runat="server" TextMode="MultiLine" CssClass="form-control validate[required,custom[integer]]"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 25%;">
                                ...
                                <td style="width: 25%;">
                                    <asp:UpdatePanel ID="UpdatePanel6" UpdateMode="Conditional" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:DropDownList ID="ddlcoaltype" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlcoaltype_SelectedIndexChanged"
                                                AutoPostBack="true">
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                ...
                                <td style="width: 25%;">
                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <asp:DropDownList ID="ddlcoalgrade" runat="server" CssClass="form-control" AutoPostBack="false">
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                ...
                <div class="box bordered-box blue-border">
                    ...
                    <div class="box-content">
                        <table cellpadding="5" cellspacing="10" border="0" width="100%">
                            <tr >
                                <td id="trtax1" runat="server" style="display: none;width: 25%;">
                                    <p>
                                        <strong>Tax</strong>
                                    </p>
                                ...
                                <td id="trtax2" runat="server" style="display: none; width: 25%;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 80%;">
                                            <asp:TextBox ID="txttransportationcost" runat="server" onblur="CalculateGrandTotal();"
                                                CssClass="form-control  validate[required]" onkeypress="return isNumberWthDot(event, this.value)"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 20%;">
                ...
                <div>
                    <asp:Button ID="btnsubmit" runat="server" CssClass="btn btn-danger" Text="Update"
