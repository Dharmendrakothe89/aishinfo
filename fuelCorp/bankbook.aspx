                    ...
                    <div class="box-content">
                        <asp:UpdatePanel ID="uplist" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvbankbook" runat="server" CellPadding="3" AllowPaging="true"
                                    PageSize="8" AutoGenerateColumns="false" CssClass="Grid" PagerStyle-CssClass="pgr" OnPageIndexChanging="gvbankbook_OnPageIndexChanging"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="BANKLEDGER" HeaderText="BANK LEDGER" ItemStyle-VerticalAlign="Middle"
                                            ItemStyle-HorizontalAlign="Left" ItemStyle-Width="250px" />
