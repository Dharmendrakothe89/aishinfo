<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.master" AutoEventWireup="true"
    CodeFile="bankvoucher.aspx.cs" Inherits="bankvoucher" %>
            ...
            $(".autosuggest").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        url: "bankvoucher.aspx/GetAutoCompleteData",
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddlvouchertype" runat="server" AutoPostBack="true" CssClass="form-control validate[required]"
                                                ...
                                                <asp:ListItem Text="Bank Payment" Value="4" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="Bank Receive" Value="3"></asp:ListItem>
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            ...
                            <tr>
                                <td align="left" colspan="4">
                                    ...
                                    <asp:TextBox ID="txtnarration" runat="server" Style="text-transform: uppercase;"
                                        CssClass="form-control  validate[required]" Width="450px" TextMode="MultiLine"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
