                            ...
                            <asp:GridView ID="gvmemberlist" runat="server" CellPadding="3" AllowPaging="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="" ItemStyle-VerticalAlign="Middle" ItemStyle-Font-Bold="true"
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkdetails" runat="server" Text='activate' Width="63px" Height="21px"
                                                BackColor="#84B899" ForeColor="White" Font-Bold="true" 
                                                OnClick="lnkdetails_Click" CommandName="ACTIVATE" CommandArgument='<%#Eval("SRNO") %>'></asp:LinkButton>

                                            <asp:LinkButton ID="LinkButton1" runat="server" Text='activate' Width="63px" Height="21px"
                                                BackColor="#84B899" ForeColor="White" Font-Bold="true" 
                                                OnClick="lnkdetails_Click" CommandName="DEACTIVATE" CommandArgument='<%#Eval("SRNO") %>'></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
