                    ...
                    <asp:UpdatePanel ID="uplist" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="gvmemberlist" runat="server" CellPadding="3" AllowPaging="true"
                                ...
                                AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="gvlookup_OnPageIndexChanging" OnRowDataBound="gvmemberlist_RowDataBound" >
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SEMICODE" HeaderText="SAMI CODE" ItemStyle-VerticalAlign="Middle"
                                    ...
                                    <asp:BoundField DataField="SPONSORNAME" HeaderText="SPONSOR NAME" ItemStyle-VerticalAlign="Middle"
                                        ItemStyle-HorizontalAlign="Left" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="SPONSORSEMICODE" HeaderText="SPONSOR SAMI CODE" ItemStyle-VerticalAlign="Middle"
                                        ItemStyle-HorizontalAlign="Left" ItemStyle-Width="150px" />
                                    ...
                                    <asp:TemplateField HeaderText="" ItemStyle-VerticalAlign="Middle" ItemStyle-Font-Bold="true"
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkactivate" runat="server" Text='Activate' Width="100px" Height="21px"
                                                BackColor="#84B899" ForeColor="White" Font-Bold="true" 
                                                OnClick="lnkdetails_Click" CommandName='<%#Eval("ACTIVATE") %>' CommandArgument='<%#Eval("SRNO") %>'></asp:LinkButton>

                                            <asp:LinkButton ID="lnkdeactivate" runat="server" Text='De-Activate' Width="100px" Height="21px"
                                                BackColor="#84B899" ForeColor="White" Font-Bold="true" 
                                                OnClick="lnkdetails_Click" CommandName='<%#Eval("ACTIVATE") %>' CommandArgument='<%#Eval("SRNO") %>'></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
