        ...
        if (txtpassword.Text.Trim() != string.Empty)
        {
            ...
            if (obj.Insert(false, "registrationtable", condition))
            {
                ...
                if (obj1.Insert(true, "usertable"))
                {
                    ...
                    string link = "http://globalfreedom.aishinfotech.net/activatelink.aspx?id=" + txtmememail.Text.Trim().ToLower() + "&psd=" + txtpassword.Text.Trim();
                    ...
                    try
                    {
                        ...
                        myMessage.From = new MailAddress("info@aishinfotech.net", "Global Freedom");
                        myMessage.To.Add(txtmememail.Text);
                        myMessage.Subject = "Registration";
                        ...
                        System.Net.NetworkCredential myCredential = new System.Net.NetworkCredential("info@aishinfotech.net", "$hardul@123");
                        mySmtpClient.Host = "50.28.62.129";
